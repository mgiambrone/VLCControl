    ...
    $.ajax({
        ...
        success: function (data, status, jqXHR) {
            if (current_que == 'main') {
                ...
                rate = parseInt(Math.round($('rate', data).text() * 100) / 100);
                $('#audioSlider').slider({
    ...
    $.ajax({
        ...
        success: function (data, status, jqXHR) {
            ...
            if (current_que == 'stream') {
                ...
                $('#current5Time').append(format_time(isNaN($('[name="Current"] instance', data).attr('time')) ? 0 : $('[name="Current"] instance', data).attr('time') / 1000000));
                $('#currentDayTime').append(format_time(isNaN($('[name="Current"] instance', data).attr('time')) ? 0 : $('[name="Current"] instance', data).attr('time') / 1000000));
                $('#seekSlider').slider({
